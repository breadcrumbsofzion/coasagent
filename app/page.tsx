...
import { StarWarsFooter } from "@/components/star-wars-footer"
...
function COASAGENTConfigContent() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(fetchAgentStatus, 42000) // Updated to 42 seconds
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="hardFacts" className="text-sm">
                        Hard facts 🔒{" "}
                        <span className="text-muted-foreground">(Overrides all personality settings)</span>
                      </Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Checkbox
                ...
                <CardContent className="pt-6">
                  ...
                  {agentStatus === "running" && (
                    <p className="text-sm text-muted-foreground mt-2">
                      Agent is running and will generate content every 42 seconds.
                    </p>
                  )}
                </CardContent>
              </Card>
